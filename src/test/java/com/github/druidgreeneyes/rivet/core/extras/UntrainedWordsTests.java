...
public class UntrainedWordsTests {
  ...
  public final void testRivettizeText() {
    final RIV riva = UntrainedWordsArray.rivettizeText(test_text_a,
                                                       1000,
                                                       8);
    final RIV rivb = UntrainedWordsArray.rivettizeText(test_text_b,
                                                       1000,
                                                       8);
